...
| SAM 3.1 text-prompt proposal helper | **optional, not started.** Needs SAM 3 specifically — SAM 2 has no text prompting and cannot substitute. See TRAINING.md | Robert |
