...
Version 2 resolves thirteen open questions raised by component 3. The rulings are listed in the changelog at the bottom. Where this document and documents 1, 2 or 3 disagree, **this document wins.**
...
Nullable: `team`, `track_id`, `field_x`, `field_y`. Everything else is required.
